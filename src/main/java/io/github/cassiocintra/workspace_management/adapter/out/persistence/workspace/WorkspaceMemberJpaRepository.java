...
import io.github.cassiocintra.workspace_management.adapter.out.persistence.entity.WorkspaceMemberId;
...
public interface WorkspaceMemberJpaRepository extends JpaRepository<WorkspaceMemberEntity, WorkspaceMemberId> {
    ...
    boolean existsByIdWorkspaceIdAndIdUserId(UUID workspaceId, String userId);
